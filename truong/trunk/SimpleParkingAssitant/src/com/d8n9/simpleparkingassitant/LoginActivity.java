...
public class LoginActivity extends Activity {
	...
	private String[] DUMMY_CREDENTIALS = new String[] {
			"foo@example.com:hello", "bar@example.com:world", "truong@test.com:hello" };
//	private ArrayList<String> dummyCredentials = new ArrayList<String>();
//	dummyCredentials.add("truong@test.com:hello");

	/**
	 * The default email to populate the email field with.
	 */
	public static final String EXTRA_EMAIL = "thanhtruong.np@gmail.com";
